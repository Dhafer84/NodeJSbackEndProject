...
exports.getAllUsers = (req, res) => {
  User.find()
    .select('username email profile roles statusUser statusCompte') // Sélectionner les champs que vous souhaitez renvoyer
    .populate('roles', 'name') // Utiliser la méthode populate pour récupérer les informations des rôles
    .then(users => {
      res.json(users);
    })
    .catch(err => {
